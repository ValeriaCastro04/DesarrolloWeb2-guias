...
export function Header({cart, total, vaciarCarrito, eliminarProducto, sumarCantidad, restarCantidad}){
                                    ...
                                    <tr key={guitar.id}>
                                        ...
                                        <td className="flex align-items-start gap-4">
                                            <button
                                                ...
                                                onClick={()=> restarCantidad(guitar.id)}
                                            >
                                                -
                                            </button>
                                                {guitar.quantity}
                                            <button
                                                type="button"
                                                className="btn btn-dark"
                                                onClick={() => sumarCantidad(guitar.id)}
                                            >
                                                +
                                            </button>
                                        </td>
